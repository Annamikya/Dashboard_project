...
class Timetable(models.Model):
    ...
    department = models.ForeignKey('students.Department', on_delete=models.CASCADE, related_name='timetables')
...
class Holiday(models.Model):
    ...
    departments = models.ManyToManyField('students.Department', blank=True)
    created_at = models.DateTimeField(auto_now_add=True)
